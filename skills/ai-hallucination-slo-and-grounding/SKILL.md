---
name: ai-hallucination-slo-and-grounding
description: Use when treating hallucination as a measurable, budgeted reliability property of an AI feature — citation grounding as a product surface, "I don't know" thresholds, retrieval-rerank cutoffs, hallucination-rate SLO + error budget, incident response when the budget is burned, and the grounding-and-citation UX contract.
metadata:
  portable: true
  compatible_with:
  - claude-code
