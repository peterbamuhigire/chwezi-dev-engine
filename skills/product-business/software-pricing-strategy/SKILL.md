...
description: Use when designing or reviewing software pricing, packaging, value metrics, tiers, freemium, discounts, negotiation, or willingness-to-pay tests.
metadata:
  portable: true
  compatible_with:
  - Codex
...
Pricing must preserve a coherent value metric, enforceable tier fences, stated discount authority, customer migration treatment, and an evidence plan for uncertain price points.

## Outputs

| Artefact | Consumer | Acceptance condition |
|---|---|---|
| Pricing and packaging recommendation | Product, finance, and sales owners | Value metric, tier fences, price points, discount authority, migration treatment, and willingness-to-pay test are stated with evidence or flagged assumptions |
