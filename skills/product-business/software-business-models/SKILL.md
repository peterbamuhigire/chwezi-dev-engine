...
description: Use when selecting or reviewing a software product, service, hybrid, platform, subscription, perpetual, open-source, or transition business model.
metadata:
  portable: true
  compatible_with:
  - Codex
...
The recommended model must reconcile payer, value exchange, revenue timing, delivery cost, channel incentives, transition burden, and a falsifiable adoption assumption.

## Outputs

| Artefact | Consumer | Acceptance condition |
|---|---|---|
| Business-model decision record | Founder, product lead, or investment committee | Customer, payer, value exchange, revenue mechanics, cost drivers, transition risks, and rejected alternatives are explicit |
