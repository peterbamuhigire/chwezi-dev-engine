...
|---|---|---|
| Domain evidence | yes | plan catalogue, AI feature keys, model tiers, quotas, tenant overrides, and upgrade policy |

## Outputs

- Produce: entitlement matrix, enforcement contract, denial reasons, override controls, and upgrade UX rules.
