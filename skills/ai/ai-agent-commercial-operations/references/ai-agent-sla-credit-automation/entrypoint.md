> Consolidated from skills/ai-agent-sla-credit-automation/SKILL.md into ai-agent-sla-and-customer-commitments on 2026-05-13. Moved into ai-agent-commercial-operations on 2026-09-24; load this through skills/ai/ai-agent-commercial-operations/SKILL.md, not as an active skill entrypoint.
