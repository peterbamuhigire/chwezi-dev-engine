...
Each quarter the suite is run as a **drill** through `ai-agent-compliance-controls/references/ai-agent-drill-evidence-and-cadence` with:
...
Cross-links: `ai-agent-compliance-controls/references/ai-agent-drill-evidence-and-cadence`, `ai-agent-soc2-controls` (CC7.3, CC9.1), `ai-agent-iso27001-controls` (A.5.7, A.8.29), `ai-agent-evidence-automation`.
## Inputs
