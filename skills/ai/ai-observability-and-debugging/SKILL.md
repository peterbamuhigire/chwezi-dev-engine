...
|---|---|---|
| Domain evidence | yes | trace identifiers, prompt/model versions, tenant privacy rules, stage boundaries, retention policy, and incident questions |

## Outputs

- Produce: trace schema, dashboards, replay procedure, redaction controls, alert rules, and ticket-to-trace workflow.
