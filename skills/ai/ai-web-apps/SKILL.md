---
name: ai-web-apps
description: Use when designing or building an AI-enhanced web app with chat, RAG, MCP tools, streaming, provider abstraction, feature gates, token budgets, and output guardrails.
metadata:
  portable: true
  compatible_with:
  - Codex
...
|---|---|---|
| Domain evidence | yes | web runtime, AI user journeys, tenancy model, provider constraints, tool authority, budgets, and UI state requirements |

## Outputs

- Produce: web AI architecture, provider boundary, streaming/state contract, module gate, token ledger, and guardrail tests.
