> Consolidated from skills/ai/ai-agent-drill-evidence-and-cadence/SKILL.md into ai-agent-compliance-controls on 2026-09-24. Load this through skills/ai/ai-agent-compliance-controls/SKILL.md, not as an active skill entrypoint.
...
|---|---|---|
| Domain evidence | yes | drill type, cadence policy, scenario, participants, target thresholds, and evidence store |

## Outputs

- Produce: drill record, measured results, failed-threshold actions, signed evidence pack, and cadence status.
