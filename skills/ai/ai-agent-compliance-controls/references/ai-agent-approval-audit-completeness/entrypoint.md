> Consolidated from skills/ai/ai-agent-approval-audit-completeness/SKILL.md into ai-agent-compliance-controls on 2026-09-24. Load this through skills/ai/ai-agent-compliance-controls/SKILL.md, not as an active skill entrypoint.
